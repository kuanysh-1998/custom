...
@Component({
  ...
  styleUrls: [
    ...
    '../add/add-location.component.scss',
  ],
...
export class EditLocationComponent implements OnInit {
  ...
  ngOnInit(): void {
    if (this.data.location) {
      this.form.setValue({
        ...
        organizationId: this.data.location.organizationId,
        radius: this.data.location.radius,
      });
    }
  ...
  editLocation(): void {
    ...
    this.locationService
      ...
      .pipe(untilDestroyed(this))
      .subscribe(() => {
        this.dialogService.close(EditLocationComponent, { saved: true });
      });
  }

  private readCurrentLocationFromBrower(): void {
    this.latitude = this.data.location.coordinates.latitude;
    this.longitude = this.data.location.coordinates.longitude;
  }

  closeDialog(): void {
    this.dialogService.close(EditLocationComponent);
  }
  ...
  handleKeyboardEvent(event: KeyboardEvent) {
    switch (event.key) {
      case 'Enter':
        this.activeButton === 'save' ? this.editLocation() : this.closeDialog();
        break;
      case 'ArrowLeft':
